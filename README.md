...
- **🍎 Apple 스타일 디자인**: macOS 네이티브 테마와 SF Pro 폰트 사용
- **📱 직관적인 인터페이스**: 깔끔한 레이아웃과 명확한 옵션 배치
- **⚡ 실시간 진행률**: 시각적 진행률 바와 예상 완료 시간
- **📊 상세한 통계**: 완료/실패/총 개수 실시간 표시
- **📝 로그 표시**: 실시간 다운로드 로그 확인
- **🔍 URL 검증**: 버튼 클릭으로 URL 유효성 검사
- **📁 폴더 선택**: 파일 탐색기로 저장 경로 선택
- **🎯 스마트 모드**: 균형/고성능/극한/안정 모드 선택
- **📺 화질 선택**: 자동/최고/1080p/720p/480p/360p 옵션
...
- 🍎 **Apple 스타일 GUI**: macOS 네이티브 디자인 적용
- 📱 **직관적인 인터페이스**: 깔끔한 레이아웃과 명확한 옵션 배치
- ⚡ **스마트 모드 시스템**: 균형/고성능/극한/안정 모드
- 📊 **실시간 통계**: 완료/실패/총 개수 표시
- 🎯 **개선된 화질 선택**: 자동/최고/1080p/720p/480p/360p
- 🔧 **파일 검증 로직 개선**: restrictfilenames 옵션 대응
- 📝 **향상된 로그 시스템**: Apple 스타일 색상과 폰트
